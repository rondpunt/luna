...
import { ChevronRight, Lock, Download, Trash2, AlertTriangle, Gem } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
        ...
        >
          <span
            ...
            style={{ fontSize: 22, color: "#E8834A" }}
          >
            {initials}
          </span>
        </div>
        <div>
          <p
            className="font-display"
            style={{ fontSize: 24, color: "var(--text)", letterSpacing: "-0.02em" }}
          >
            {name}
          </p>
      ...
      <div className="surface" style={{ padding: 24, marginBottom: 24 }}>
        ...
        <p
          className="font-display"
          style={{ fontSize: 32, color: "var(--text)", letterSpacing: "-0.02em", marginBottom: 8 }}
        >
          Gratis
        </p>
        ...
        <Link to="/pricing">
          <button className="btn btn-primary press" style={{ fontSize: 15 }}>
